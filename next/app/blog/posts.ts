...
export const posts: Record<string, BlogPost> = {
  stories: {
    ...
    content: [
      ...
      "My best advice is that you do something that is slightly uncomfortable. It is something that you know you can do and where you know you will be fine doing. Because the reason it is uncomfortable is probably that your brain isn’t sure what negative reaction/outcome the action might produce. Only way to find out is to collect more data by doing it, you can’t simulate the data, it needs to be done.",
